                ...
                children: React.createElement("div", {
                    ...
                    children: [
                        React.createElement("div", {
                            ...
                            children: [
                                meta.source && React.createElement(Tooltip, {
                                    text: "Source",
                                    children: (props) =>
                                ...
                                meta.website && React.createElement(Tooltip, {
                                    text: "Website",
                                    children: (props) =>
                                        React.createElement(VApi.getModule.find("Clickable").default, {
                                            ...props,
                                ...
                                meta.invite && React.createElement(Tooltip, {
                                    text: "Server Invite",
                                    children: (props) =>
                                        React.createElement(VApi.getModule.find("Clickable").default, {
                                            ...props,
                                            ...
                                            onClick: () => {
                                                if (meta.invite !== "") VApi.Utilities.joinServer(meta.invite); VApi.getModule.find(["pushLayer"]).popLayer(); VApi.getModule.find(["closeAllModals"]).closeAllModals();
                                            }
                                        }),
                                }), 
                                meta.license && React.createElement(Tooltip, {
